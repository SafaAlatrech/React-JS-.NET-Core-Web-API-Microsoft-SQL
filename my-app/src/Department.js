...
import { varaibles} from './Variables.js'
...
export class Department extends Component {
    ...
    refreshList(){
        ...
        .then (data=>{
         this.setState({departments:data,departmentWithoutFilter:data})
        })
    } 
    ...
    editClick(dep){
     ...
     CreateClick () { 
      ...
      deleteClick (id) { 
         ...
         {
         fetch(varaibles.API_URL+'department/'+id,{
           method : 'DELETE',
           headers:{
            'Accept': 'application/json',
            'Content-type' : 'application/json'},
                  ...
                  <tr>
                     <th>
                        ...
                        <div className='d-flex flex-row'>
                          {/* For design icons departmentId for filter */}
                     ...
                     <th>
                         {/* For Filter  */}
                         <div className='d-flex flex-row'>
                          {/* For design icons departmentName for filter */}
                          <input className='form-control m-2'
